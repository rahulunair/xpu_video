...
class VideoGenerationServer:
    ...
    async def __call__(self, request):
        """
        This method makes the class callable and compatible with Ray Serve.
        """
        return await self.app(request.headers, request.body)
